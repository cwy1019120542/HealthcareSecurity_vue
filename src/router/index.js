...
import chronic_illness from '@/view/chronic_illness'
import evidence_rate from '@/view/evidence_rate'
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/chronic_illness', 
          component: chronic_illness, 
          name: 'chronic_illness', 
        },
        {
          path: '/evidence_rate', 
          component: evidence_rate, 
          name: 'evidence_rate', 
        }, 
      ]
    }, 
