...
var create_pdf = function(canvas, html, watermark_text) {
    var pdf = new JsPDF('p', 'mm', 'a4'); // A4纸，纵向
    var ctx = canvas.getContext('2d');
    var a4w = 210; var a4h = 297; // A4大小，210mm x 297mm，四边各保留10mm的边距，显示区域190x277
...
var download_pdf = function(html, watermark_text, file_name) {
    html2Canvas(html, {
      allowTaint: false,
      taintTest: false,
      logging: false,
      ...
      scale: 1 // 按比例增加分辨率
        ...
        create_pdf(canvas, html, watermark_text).save(file_name + '.pdf');
    });
  }

var print_pdf = function(html, watermark_text) {
    html2Canvas(html, {
      allowTaint: false,
      taintTest: false,
      logging: false,
      ...
      scale: 1 // 按比例增加分辨率
        ...
        var pdf = create_pdf(canvas, html, watermark_text)
        pdf.autoPrint();
        pdf.output('dataurlnewwindow');
    });
  }

export {authentication, update_town, update_village, reset, download, update_cure_type, deal_error, search, update_attribute, alert, add, download_pdf, print_pdf}
