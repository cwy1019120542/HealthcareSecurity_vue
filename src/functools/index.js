...
var create_pdf = function(self, file_name, html, watermark_text) {
    html2Canvas(html, {
      allowTaint: false,
      taintTest: false,
      logging: false,
    ...
    pdf.text(25, 105, watermark_text);
...
export {authentication, update_town, update_village, reset, download, update_cure_type, deal_error, search, update_attribute, alert, add, create_pdf}
